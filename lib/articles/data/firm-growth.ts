...
export const firmGrowthArticles: Article[] = [
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Lead volume, contact rate, consultation rate, and retention rate together tell a complete story that lead volume alone never will. Firms that build genuine visibility into this full funnel make far better investment decisions about where additional growth spending will actually pay off.",
      },
      {
        type: "heading",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "paragraph",
        text: "Formal development programs that train multiple attorneys in relationship-building, networking, and content creation spread the burden and the opportunity across the firm, rather than concentrating both the value and the risk in one or two people's personal networks.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Firms that treat business development as exclusively a senior partner responsibility often struggle to build durable growth capacity. Involving associates in appropriate development activities — speaking opportunities, community involvement, content contribution — builds both individual skill and firm-wide resilience over time.",
      },
      {
        type: "heading",
  ...
  },
  {
    ...
    content: [
      {
        type: "paragraph",
        text: "Building a successful law firm from the ground up follows a rough sequence, even though the specific timeline and details vary enormously by practice area and market. Understanding the sequence helps a new or growing firm avoid skipping foundational steps in the rush to generate revenue.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "Early clients typically come from an attorney's existing personal and professional network before any broader marketing channel has had time to mature. Being deliberate about tapping this network — rather than assuming it will happen organically — accelerates the critical early growth period.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "As initial cases generate revenue, reinvesting in SEO, content, and eventually paid channels including a vetted [pay-per-lead program](/buy-leads) builds the more scalable growth engine that personal relationships alone can't sustain indefinitely.",
      },
      {
        type: "heading",
      ...
      {
        type: "paragraph",
        text: "As the firm grows, transitioning from founder-dependent growth to institutional development — training other attorneys, building documented processes, diversifying referral sources — determines whether growth continues to scale or plateaus at the founder's personal capacity limit.",
      },
      {
        type: "heading",
