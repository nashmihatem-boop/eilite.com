...
export function Hero() {
  ...
  useEffect(() => {
    ...
    // Keeping the video out of the initial server-rendered HTML means the browser's
    // preload scanner never starts fetching it before JS even runs, and deferring to
    // idle time means it never competes with critical page resources during first paint.
